...
<body>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse pull-right" id="myNavbar">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu4 active"><a href="latest-quotes">জনপ্রিয় বাণী</a></li>
    ...
    $sql="SELECT authors.id,authors.name AS a_name,authors.app_id,authors.icon,quotes.id AS q_id,quotes.quote,tags.id,tags.name FROM authors JOIN quotes ON authors.id=quotes.author_id JOIN tags ON quotes.id=tags.id WHERE authors.app_id=1 GROUP BY authors.name ORDER BY RAND() limit 10 ";
...
?>
                        <div class="author-quotes">
                            <h3 class="text-center">জনপ্রিয় উক্তিসমুহ</h3>
                            <div class="hr-lines">
                                <div class="hr1"></div>
                                <div class="hr2"></div>
                            </div>
