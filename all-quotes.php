...
<body>
        ...
        <div class="row">
            <section id="all-quote">
                <div class="col-md-8 col-lg-8 col-xs-12">
                    <h1 class="text-center">সমগ্র বাণী ভান্ডার</h1>
                    <div class="hr-lines">
                        <div class="hr1"></div>
                        <div class="hr2"></div>
                    </div>
    ...
    $sql="SELECT quotes.id AS q_id,quotes.quote,quotes.author_id,authors.id,authors.name,authors.icon,authors.app_id FROM quotes JOIN authors ON authors.id=quotes.author_id WHERE authors.app_id=1 ORDER BY RAND()";
                ...
                <div class="col-md-4 col-lg-4 col-xs-12">
                    <section id="categories">
                        ...
                        <div class="category-menu">
                            <ul class="list-group">
                                <?php
            $sql2="SELECT tags.id,tags.name AS t_name,tags.app_id FROM tags WHERE app_id=1 ORDER BY RAND()";
